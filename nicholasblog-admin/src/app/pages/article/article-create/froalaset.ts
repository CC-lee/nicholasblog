...
interface Froalaset {
  ...
  events: {
    ...
    imageremoved: {
      ...
      updateTemp(e: any, editor: any, $img: any): void,
    }
  };
}
...
var froalaset: Froalaset = {
  ...
  events: {
    ...
    imageremoved: {
      ...
      updateTemp: function (e, editor, $img) {
        const { title, classify } = this.article;
        const { _id } = this.temp;
        Object.assign(this.articleTemp, { _id, title, content: editor.html.get(), classify });
