...
export const IMAGES_ROOT = `${execLib.assetsName}img/`;
...
export const layoutPaths = {
  images: {
    ...
    amMap: `${execLib.assetsName}img/theme/vendor/ammap/`,
    amChart: `${execLib.assetsName}img/theme/vendor/amcharts/dist/amcharts/images/`
  }
};
